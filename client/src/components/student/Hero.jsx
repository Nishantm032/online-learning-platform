...
const Hero = () => {
  ...
  md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
    ...
    font-bold text-gray-800 max-w-,xl mx-auto'>Empower your future with the <br /> courses designed to <span className='text-blue-600'>
      fit your choice.</span > <img className='md:block hidden absolute -bottom-7 right-0' src={assets.sketch} alt="sketch" /> </h1>
 

  <p className='md:block hidden text-gray-500 max-w-2xl mx-auto'>We bring together world-class instructors, intereactive content, and a
