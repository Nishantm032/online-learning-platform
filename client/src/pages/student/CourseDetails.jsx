...
text-course-details-heading-small font-semibold text-gray-800"
          ...
          <p className="text-sm">
            Course by{" "}
            <span className="text-blue-600 underline">Nishant Mishra</span>
          </p>
          ...
          <div className="pt-8 text-gray-800">
            ...
            <div className="pt-5">
              {courseData.courseContent.map((chapter, index) => (
                ...
                >
                  <div
                    className="flex items-center justify-between px-4 py-3 coursor-pointer select-none"
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <img
                        ...
                        alt="arrow-icon"
                      />
                      <p className="font-medium mf:text-base text-sm">
      ...
      md:rounded-none overflow-hidden bg-white min-w [300px] sm:min-w-[420px]"
        ...
        md:pt-4 text-gray-500"
            ...
            <div className="pt-6">
              <p className="md:text-sl text-lg font-medium text-gray-800">
